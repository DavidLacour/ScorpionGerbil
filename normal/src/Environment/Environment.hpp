...
public:
     ...
     */
    void morte(OrganicEntity* entity);
     ...
     */
    unsigned int compterGerbil() const;
     ...
     */
    unsigned int compterScorpion() const;
     ...
     */
    unsigned int compterFood() const;
...
private:
    ...
    std::list<OrganicEntity*> listTuer_;         ///< List of entities marked for deletion
