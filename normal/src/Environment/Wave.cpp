...
void Wave::draw(sf::RenderTarget&  target) const
{
    ...
    for (auto pairAngle : wave_list_pair_angles_) {
...
double Wave::waveGetWaveIntensity()
{
    return wave_intensity_;
}

bool Wave::waveIsPointInside(const Vec2d& point)
{
...
bool Wave::waveIsPointTouching(const Vec2d& point)
{
