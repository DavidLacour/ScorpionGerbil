...
public:
     ...
     */
    Scorpion(const Vec2d& position, const double& energie, const bool& isFemale);
     ...
     */
    Scorpion(const Vec2d& position, const double& energie, const bool& isFemale, const sf::Time& ageLimit);
